            ...
            <form action="{{route("post.store")}}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="6" placeholder="Write your post description..."
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                </div>
